...
covid_dates <- subset(df, Date > '2020-01-01' & Date < '2020-08-31')
...
# Conclusion
#### Garch modeling brought the residuals closer to normal distribution. Garch modeling also revealed how volatility has changed over time. Year 1 yield deviates more from a normally distributed white noise process than a 20 year yield. 